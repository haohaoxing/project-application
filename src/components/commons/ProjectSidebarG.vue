  ...
  <!--侧边栏-->
    <div class="sidebar">
        ...
        <div class="sidebarOne">
            <div class="sidebarTop">管理者</div>
            <ul class="sidebarBottom">
                  <li><router-link class="addSidebar" to="/Administratoraudit">申请列表</router-link></li>
                  <li><router-link to="/ProcurementProgressG">采购进度</router-link></li>
                  <li><router-link to="/BoughtEquipmentG">已购设备</router-link></li>
                  <li><router-link to="/CompleteProject">完成项目</router-link></li>
...
.sidebar h1{
  ...
  text-align: center;
  line-height: 25px;
  border:1px solid #235f9e;
  background:#64a8e9 url(../../assets/images/common/bg_2.png) repeat center;
}
.sidebarOne{
  width:100%;
}
.sidebarTop,.sidebarBottom li a{
/*  width:100%;*/
  line-height: 32px;
